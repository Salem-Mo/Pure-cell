    ...
    <footer className="bg-slate-50 pt-12 pb-6 px-6 rtl border-t border-slate-200">
      <div className="flex flex-col items-center gap-8 max-w-4xl mx-auto">
        ...
        <div className="flex gap-6">
          ...
          <a href="https://www.facebook.com/adel.khater100" target="_blank" className="text-[#0056b3] hover:scale-110 transition-transform" title="م/ عادل خاطر">
            <Facebook size={24} />
          </a>
          <a href="https://wa.me/201276553540" target="_blank" className="text-[#25D366] hover:scale-110 transition-transform flex items-center justify-center w-6 h-6" title="واتساب">
